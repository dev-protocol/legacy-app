...
export const head = async ({ title, url, injection }: Opts) => html`
	<head>
		...
		<link
			...
			type="image/png"
			sizes="32x32"
			href="//asset.devtoken.rocks/favicon-32x32.png"
		/>
		<link
			rel="icon"
			type="image/png"
			sizes="16x16"
			href="//asset.devtoken.rocks/favicon-16x16.png"
		/>
		<link
			rel="apple-touch-icon"
			sizes="180x180"
			href="//asset.devtoken.rocks/apple-touch-icon.png"
		/>
		<link rel="manifest" href="//asset.devtoken.rocks/site.webmanifest" />
		<link
			rel="mask-icon"
			href="//asset.devtoken.rocks/safari-pinned-tab.svg"
			color="#5bbad5"
		/>
